/**
 *Submitted for verification at hecoinfo.com on 2021-03-11
*/
...
contract Oracle is Epoch {
    ...
    constructor(
        ...
        IMdexPair _pair = IMdexPair( IMdexFactory(_factory).pairFor(_tokenA, _tokenB) );
        pair = _pair;
        token0 = _pair.token0();
        token1 = _pair.token1();
    ...
    /** @dev Updates 1-day EMA price from mdex.  */
